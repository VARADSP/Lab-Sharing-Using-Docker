...
$command='sudo docker run -itd -p ' .$portno.':80 -v /root/containers/'.$portno.'/scilab:/root:Z scilab';
//$command = 'sudo docker run -itd -p ' .$portno.':80 scilab';
echo $command;
