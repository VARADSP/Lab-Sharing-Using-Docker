...
$command='sudo docker run -itd -p ' .$portno.':80 -v /root/containers/'.$portno.'/codeblock:/root:Z codeblock';
//$command = 'sudo docker run -itd -p ' .$portno.':80 codeblock';

//$command = 'sudo docker run -itd -p ' .$portno.':3000 -v /root/containers/'.$portno.'/C:/root:Z c-container';
echo $command;
...
$cmd1 = 'sudo firefox ' .$url ;
echo '<pre>';
    $content1 = system($cmd1, $ret);
    echo '</pre>';
